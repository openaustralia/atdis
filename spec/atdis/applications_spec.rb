  ...
  context "base_url passed as string" do
    ...
    describe "#all" do
      it do
        ...
        ATDIS::ApplicationsResults.should_receive(:read).with(ATDIS::SeparatedURL.parse("http://www.council.nsw.gov.au/atdis/1.0/applications.json")).and_return(applications_results)
